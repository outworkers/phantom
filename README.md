...
The latest major release is: ```val phantomVersion = 1.2.1```.
...
The latest development version is ```val phantomVersion = 1.2.1```, found only on our internal Maven repository.
