 ...
 * This file is re-packaged from akka.util to avoid a hard dependency.
 * Copyright for the contents of this file belong to the original owner, Typesafe Inc.
 */
...
object ByteIterator {
  object ByteArrayIterator {
    ...
    protected[phantom] def apply(array: Array[Byte]): ByteArrayIterator =
      new ByteArrayIterator(array, 0, array.length)

    protected[phantom] def apply(array: Array[Byte], from: Int, until: Int): ByteArrayIterator =
  ...
  object MultiByteArrayIterator {
    ...
    protected[phantom] def apply(iterators: LinearSeq[ByteArrayIterator]): MultiByteArrayIterator =
  ...
  class MultiByteArrayIterator private (private var iterators: LinearSeq[ByteArrayIterator]) extends ByteIterator {
    ...
    private[phantom] def ++:(that: ByteArrayIterator): this.type = {
